      ...
      <div className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            {totalItems > 0 && (
              <span className="absolute -top-0.5 -right-0.5 bg-primary text-white text-[10px] w-4 h-4 sm:w-5 sm:h-5 rounded-full flex items-center justify-center font-bold leading-none">
          ...
          <button
            ...
            className="p-1.5 sm:p-2 text-gray-700 hover:text-red-500 transition-colors"
            title="Sair"
          >
